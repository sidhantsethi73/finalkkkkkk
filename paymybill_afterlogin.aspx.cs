...
public partial class paymybill_afterlogin : System.Web.UI.Page
{
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            Response.Redirect("landlinebill aftrlogin.aspx");
        }
        else
        {
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        {
            Session["number"] = dt.Rows[0]["number"].ToString();
            Response.Redirect("postpaidbill aftrlogin.aspx");
        }
        else
        {
            Response.Write("Number not found");
    ...
    protected void Button6_Click1(object sender, EventArgs e)
    {
        ...
        {
            Session["number"] = dt.Rows[0]["number"].ToString();
            Response.Redirect("broadbandbill aftr login.aspx");
        }
        else
        {
            Response.Write("Number not found");
