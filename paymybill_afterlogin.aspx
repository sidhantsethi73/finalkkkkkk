<%@ Page Title="" Language="C#" MasterPageFile="~/afterlogin.master" AutoEventWireup="true" CodeFile="paymybill_afterlogin.aspx.cs" Inherits="paymybill_afterlogin" %>
        ...
        <table style="width: 100%; border-style: solid; border-width: 1px">
            ...
            <tr>
                ...
                <td style="height: 28px">
                    <asp:TextBox ID="TextBox4" runat="server" Width="135px" MaxLength="7"></asp:TextBox>
