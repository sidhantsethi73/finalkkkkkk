<%@ Page Title="" Language="C#" MasterPageFile="afterlogin.master" AutoEventWireup="true" CodeFile="mobilecon.aspx.cs" Inherits="mobilecon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <br />
    <br />
    <center> you want to take a connection of BSNL.
    <br />
    You have to register first</center>
    <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click1">REGISTER HERE</asp:LinkButton>
</asp:Content>
