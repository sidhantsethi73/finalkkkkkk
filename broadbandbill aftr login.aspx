<%@ Page Title="" Language="C#" MasterPageFile="~/afterlogin.master" AutoEventWireup="true" CodeFile="broadbandbill aftr login.aspx.cs" Inherits="broadbandbill_aftr_login" %>
        ...
        <tr>
            <td colspan="2" bgcolor="#66CCFF" style="height: 30px">
                <asp:Button ID="Button1" runat="server" Text="Pay Bill" 
                    onclick="Button1_Click" PostBackUrl="~/Paymentafterlogin.aspx" />
            </td>
        </tr>
    </table>
</asp:Content>
