<%@ Page Title="" Language="C#" MasterPageFile="~/afterlogin.master" AutoEventWireup="true" CodeFile="Paymentafterlogin.aspx.cs" Inherits="Paymentafterlogin" %>
                                                ...
                                                <tr>
                                                    <td align="center" class="style7" colspan="4">
                                                        <asp:Button ID="Button2" runat="server" Font-Bold="True" Font-Italic="True" 
                                                            ...
                                                            ValidationGroup="cc" Width="130px" PostBackUrl="~/recieptaftrlogin.aspx" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" class="style7" colspan="4">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="3">
                                                        <asp:Button ID="Button3" runat="server" Font-Bold="True" Font-Italic="True" 
                                                            ...
                                                            Width="121px" PostBackUrl="~/recieptaftrlogin.aspx" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="3">
